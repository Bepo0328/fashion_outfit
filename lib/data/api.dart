...
class WeatherApi {
  ...
  Future<List<Weather>> getWeather(
      int x, int y, int data, String baseTime) async {
    Uri url =
        Uri.parse('$BASE_URL/1360000/VilageFcstInfoService_2.0/getVilageFcst?'
            'serviceKey=$key&'
            'pageNo=1&'
            'numOfRows=130&'
            'dataType=JSON&'
    ...
    if (response.statusCode == 200) {
      ...
      final data = groupBy(_data, (dynamic obj) => '${obj['fcstTime']}')
          .entries
          .toList();
